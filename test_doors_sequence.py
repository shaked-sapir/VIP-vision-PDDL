"""
Generate a test sequence for the doors PDDLGym environment.

This script:
1. Initializes the doors environment
...
def generate_doors_test_sequence(num_steps=10, problem_index=0):
    """
    Generate a test sequence for the doors domain.
    ...
    """
    print("="*80)
    print("GENERATING DOORS TEST SEQUENCE")
    print("="*80)
    print()

    # Initialize environment
    env_name = "PDDLEnvDoors-v0"
    ...
    output_dir = Path(__file__).parent / "doors_test_sequence"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Generate doors test sequence"
    )
    parser.add_argument(
        "--num-steps",
        type=int,
