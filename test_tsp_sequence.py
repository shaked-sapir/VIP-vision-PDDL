"""
Generate a test sequence for the TSP PDDLGym environment.

This script:
1. Initializes the TSP environment
...
def generate_tsp_test_sequence(num_steps=10, problem_index=0, max_attempts_per_step=20):
    """
    Generate a test sequence for the TSP domain.
    ...
    """
    print("="*80)
    print("GENERATING TSP TEST SEQUENCE")
    print("="*80)
    print()

    # Initialize environment
    env_name = "PDDLEnvTsp-v0"
    ...
    output_dir = Path(__file__).parent / "tsp_test_sequence"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Generate TSP test sequence with distinct observations"
    )
    parser.add_argument(
        "--num-steps",
        type=int,
