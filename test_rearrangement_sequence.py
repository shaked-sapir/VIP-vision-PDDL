"""
Generate a test sequence for the rearrangement PDDLGym environment.

This script:
1. Initializes the rearrangement environment
...
def generate_rearrangement_test_sequence(num_steps=10, problem_index=0, max_attempts_per_step=20):
    """
    Generate a test sequence for the rearrangement domain.
    ...
    """
    print("="*80)
    print("GENERATING REARRANGEMENT TEST SEQUENCE")
    print("="*80)
    print()

    # Initialize environment
    env_name = "PDDLEnvRearrangement-v0"
    ...
    output_dir = Path(__file__).parent / "rearrangement_test_sequence"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Generate rearrangement test sequence with distinct observations"
    )
    parser.add_argument(
        "--num-steps",
        type=int,
    ...
    generate_rearrangement_test_sequence(
