...
(:action move-up
	...
	:precondition (and (move-dir-up ?from ?to) (move-dir-down ?to ?from) (clear ?to) (oriented-left ?p))
	:effect (and (move-dir-up ?to ?from) (move-dir-down ?from ?to) (move-dir-left ?from ?to) (move-dir-left ?to ?from) (move-dir-right ?from ?to) (move-dir-right ?to ?from) (clear ?from) (at ?p ?from) (at ?p ?to) (oriented-up ?p) (oriented-down ?p) (oriented-right ?p) (is-goal ?from) (is-goal ?to)))
...
(:action move-left
	:parameters (?p - player ?from - location ?to - location)
	:precondition (and (oriented-right ?p))
	:effect (and (move-dir-up ?from ?to) (move-dir-up ?to ?from) (move-dir-down ?from ?to) (move-dir-down ?to ?from) (move-dir-left ?from ?to) (move-dir-left ?to ?from) (move-dir-right ?from ?to) (move-dir-right ?to ?from) (clear ?from) (clear ?to) (at ?p ?from) (at ?p ?to) (oriented-up ?p) (oriented-down ?p) (oriented-left ?p) (is-goal ?from) (is-goal ?to) (not (oriented-right ?p))))

(:action move-right
	:parameters (?p - player ?from - location ?to - location)
	:precondition (and (move-dir-left ?to ?from) (move-dir-right ?from ?to) (clear ?from) (clear ?to) (oriented-left ?p))
	:effect (and (at ?p ?to) (not (clear ?to))))
