...
(:action move-up
	...
	:precondition (and (move-dir-up ?from ?to) (move-dir-down ?to ?from) (clear ?from) (clear ?to) (oriented-up ?p) (oriented-right ?p))
	:effect (and (at ?p ?from) (not (oriented-up ?p))))
...
(:action move-right
	...
	:effect (and (move-dir-up ?from ?to) (move-dir-up ?to ?from) (move-dir-down ?from ?to) (move-dir-down ?to ?from) (move-dir-left ?from ?to) (move-dir-right ?to ?from) (clear ?from) (at ?p ?to) (oriented-up ?p) (oriented-left ?p) (oriented-right ?p) (is-goal ?from) (is-goal ?to)))
