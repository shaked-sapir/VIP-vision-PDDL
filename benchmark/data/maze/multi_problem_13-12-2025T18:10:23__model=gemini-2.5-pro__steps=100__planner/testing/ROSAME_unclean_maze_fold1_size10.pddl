...
(:action move-right
	:parameters (?p - player ?from - location ?to - location)
	:precondition (and (move-dir-left ?to ?from) (move-dir-right ?from ?to) (clear ?to) (at ?p ?from) (is-goal ?to))
	:effect (and (clear ?from) (at ?p ?to) (oriented-up ?p) (oriented-right ?p) (not (clear ?to))  (not (at ?p ?from))))
