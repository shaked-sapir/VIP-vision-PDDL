...
(:action move-up
	...
	:precondition (and (move-dir-up ?from ?to) (move-dir-down ?from ?to) (move-dir-down ?to ?from) (move-dir-left ?from ?to) (move-dir-left ?to ?from) (clear ?to) (at ?p ?from) (oriented-down ?p) (oriented-right ?p) (is-goal ?to))
	:effect (and (move-dir-up ?to ?from) (move-dir-right ?from ?to) (move-dir-right ?to ?from) (clear ?from) (at ?p ?to) (oriented-up ?p) (oriented-left ?p) (is-goal ?from) (not (move-dir-up ?from ?to))  (not (move-dir-down ?from ?to))  (not (move-dir-down ?to ?from))  (not (move-dir-left ?from ?to))  (not (move-dir-left ?to ?from))  (not (clear ?to))  (not (at ?p ?from))  (not (oriented-down ?p))  (not (oriented-right ?p))  (not (is-goal ?to))))
...
(:action move-left
	:parameters (?p - player ?from - location ?to - location)
	:precondition (and (move-dir-up ?from ?to) (move-dir-down ?from ?to) (oriented-left ?p) (is-goal ?from))
	:effect (and (move-dir-up ?to ?from) (move-dir-down ?to ?from) (move-dir-left ?from ?to) (move-dir-left ?to ?from) (move-dir-right ?from ?to) (move-dir-right ?to ?from) (clear ?from) (clear ?to) (at ?p ?from) (at ?p ?to) (oriented-up ?p) (oriented-down ?p) (oriented-right ?p) (is-goal ?to) (not (move-dir-up ?from ?to))  (not (move-dir-down ?from ?to))  (not (oriented-left ?p))  (not (is-goal ?from))))
