...
(:action move-up
	...
	:effect (and (clear ?from) (at ?p ?to) (oriented-up ?p) (not (at ?p ?from))  (not (oriented-right ?p))))
...
(:action move-left
	...
	:effect (and (move-dir-up ?from ?to) (move-dir-up ?to ?from) (move-dir-down ?from ?to) (move-dir-down ?to ?from) (move-dir-left ?from ?to) (move-dir-left ?to ?from) (move-dir-right ?from ?to) (move-dir-right ?to ?from) (clear ?from) (at ?p ?to) (oriented-down ?p) (oriented-left ?p) (oriented-right ?p) (is-goal ?from) (not (at ?p ?from))  (not (oriented-up ?p))))
