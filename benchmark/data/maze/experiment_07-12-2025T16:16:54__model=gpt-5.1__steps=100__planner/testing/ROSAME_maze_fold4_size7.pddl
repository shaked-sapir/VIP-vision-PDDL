...
(:action move-up
	...
	:precondition (and (move-dir-up ?from ?to) (move-dir-down ?to ?from) (clear ?to) (at ?p ?from) (oriented-down ?p) (oriented-right ?p))
	:effect (and (clear ?from) (at ?p ?to) (oriented-up ?p) (not (at ?p ?from))  (not (oriented-down ?p))  (not (oriented-right ?p))))
