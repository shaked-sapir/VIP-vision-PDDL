...
(:action move-up
	...
	:effect (and  (not (move-dir-down ?to ?from))  (not (at ?p ?from))  (not (oriented-up ?p))  (not (is-goal ?from))))
...
(:action move-right
	...
	:effect (and (move-dir-up ?from ?to) (move-dir-up ?to ?from) (move-dir-down ?from ?to) (move-dir-down ?to ?from) (move-dir-left ?from ?to) (move-dir-right ?to ?from) (clear ?from) (at ?p ?to) (oriented-down ?p) (oriented-left ?p) (oriented-right ?p) (is-goal ?from) (is-goal ?to)))
