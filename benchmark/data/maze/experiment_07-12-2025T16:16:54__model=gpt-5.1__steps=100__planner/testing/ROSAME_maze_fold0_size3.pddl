...
(:action move_up
	...
	:effect (and (move-dir-up ?to ?from) (move-dir-down ?from ?to) (move-dir-left ?from ?to) (move-dir-left ?to ?from) (move-dir-right ?from ?to) (move-dir-right ?to ?from) (clear ?from) (at ?p ?to) (oriented-up ?p) (oriented-left ?p) (is-goal ?from) (is-goal ?to) (not (move-dir-up ?from ?to))  (not (move-dir-down ?to ?from))  (not (clear ?to))  (not (at ?p ?from))  (not (oriented-right ?p))))
...
(:action move_right
	...
	:effect (and (move-dir-left ?to ?from) (move-dir-right ?from ?to) (clear ?from) (at ?p ?to) (oriented-right ?p) (not (clear ?to))  (not (at ?p ?from))  (not (oriented-down ?p))))
