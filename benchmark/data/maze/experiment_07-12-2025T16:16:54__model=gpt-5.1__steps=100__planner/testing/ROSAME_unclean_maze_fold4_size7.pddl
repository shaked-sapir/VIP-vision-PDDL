...
(:action move-up
	...
	:precondition (and (move-dir-up ?from ?to) (move-dir-up ?to ?from) (move-dir-down ?to ?from) (move-dir-left ?to ?from) (move-dir-right ?to ?from) (clear ?to) (at ?p ?from) (oriented-right ?p) (is-goal ?to))
	:effect (and (move-dir-down ?from ?to) (move-dir-left ?from ?to) (move-dir-right ?from ?to) (clear ?from) (at ?p ?to) (oriented-up ?p) (oriented-down ?p) (oriented-left ?p) (is-goal ?from) (not (move-dir-up ?to ?from))  (not (move-dir-left ?to ?from))  (not (move-dir-right ?to ?from))  (not (at ?p ?from))  (not (oriented-right ?p))  (not (is-goal ?to))))
...
(:action move-left
	...
	:effect (and (move-dir-left ?from ?to) (move-dir-right ?to ?from) (clear ?from) (at ?p ?to) (oriented-right ?p) (not (at ?p ?from))  (not (oriented-up ?p))))
