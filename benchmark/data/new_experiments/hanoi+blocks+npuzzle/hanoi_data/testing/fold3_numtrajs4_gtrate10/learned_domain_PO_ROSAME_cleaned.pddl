...
(:action move_disc_disc
	...
	:effect (and (clear-disc ?from) (on-disc ?disc ?to) (on-disc ?from ?disc) (on-disc ?from ?to) (on-disc ?to ?from) (smaller-disc ?disc ?to) (not (clear-disc ?to))  (not (on-disc ?disc ?from))))
