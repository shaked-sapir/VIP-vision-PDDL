...
(:action move_disc_peg
	...
	:precondition (and (clear-disc ?from) (on-disc ?disc ?from) (on-disc ?from ?disc) (on-peg ?disc ?to) (on-peg ?from ?to) (smaller-disc ?disc ?from) (smaller-disc ?from ?disc) (smaller-peg ?to ?disc))
	:effect (and ))
