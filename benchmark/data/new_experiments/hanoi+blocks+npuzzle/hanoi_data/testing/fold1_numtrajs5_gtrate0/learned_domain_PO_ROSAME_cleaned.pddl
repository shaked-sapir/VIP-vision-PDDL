...
(:action move_disc_disc
	...
	:effect (and (clear-disc ?from) (clear-disc ?to) (on-disc ?disc ?from) (on-disc ?from ?disc) (on-disc ?from ?to) (on-disc ?to ?disc) (on-disc ?to ?from) (smaller-disc ?disc ?to)))
...
(:action move_peg_disc
	...
	:precondition (and (clear-disc ?disc) (on-disc ?disc ?to) (on-peg ?disc ?from) (on-peg ?to ?from) (smaller-disc ?to ?disc) (smaller-peg ?from ?disc) (smaller-peg ?from ?to))
	:effect (and (clear-disc ?to) (not (on-peg ?disc ?from))  (not (on-peg ?to ?from))))
