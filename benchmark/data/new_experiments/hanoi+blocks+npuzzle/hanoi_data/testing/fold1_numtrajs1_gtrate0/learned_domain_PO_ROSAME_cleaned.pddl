...
(:action move_disc_disc
	...
	:precondition (and (clear-disc ?disc) (clear-disc ?from) (on-disc ?disc ?from) (on-disc ?disc ?to) (on-disc ?to ?from) (smaller-disc ?from ?disc) (smaller-disc ?from ?to) (smaller-disc ?to ?disc) (smaller-disc ?to ?from))
	:effect (and (clear-disc ?to) (on-disc ?from ?to) (on-disc ?to ?disc) (not (clear-disc ?from))  (not (on-disc ?to ?from))))
...
(:action move_disc_peg
	...
	:effect (and (clear-disc ?disc) (clear-disc ?from) (on-disc ?from ?disc) (on-peg ?disc ?to) (on-peg ?from ?to) (smaller-disc ?disc ?from)))
