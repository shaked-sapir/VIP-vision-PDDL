...
(:action move_disc_disc
	...
	:precondition (and (clear-disc ?disc) (clear-disc ?to) (on-disc ?disc ?from) (on-disc ?disc ?to) (on-disc ?from ?disc) (on-disc ?to ?from) (smaller-disc ?disc ?from) (smaller-disc ?disc ?to) (smaller-disc ?from ?disc) (smaller-disc ?to ?disc))
	:effect (and  (not (on-disc ?from ?disc))))
