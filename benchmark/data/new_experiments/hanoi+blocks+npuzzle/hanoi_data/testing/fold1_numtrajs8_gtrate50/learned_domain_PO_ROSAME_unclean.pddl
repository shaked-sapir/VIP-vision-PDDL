...
(:action move_disc_disc
	...
	:precondition (and (clear-disc ?disc) (clear-disc ?to) (on-disc ?disc ?from) (on-disc ?from ?disc) (smaller-disc ?disc ?from) (smaller-disc ?from ?disc) (smaller-disc ?to ?disc))
	:effect (and (clear-disc ?from) (on-disc ?disc ?to) (smaller-disc ?from ?to) (smaller-disc ?to ?from) (not (clear-disc ?to))  (not (on-disc ?disc ?from))  (not (on-disc ?from ?disc))  (not (smaller-disc ?disc ?from))))
