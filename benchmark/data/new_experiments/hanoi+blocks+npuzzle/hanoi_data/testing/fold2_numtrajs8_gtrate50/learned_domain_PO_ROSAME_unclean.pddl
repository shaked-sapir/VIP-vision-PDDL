...
(:action move_disc_disc
	...
	:effect (and (clear-disc ?disc) (clear-disc ?from) (on-disc ?disc ?to) (on-disc ?from ?disc) (on-disc ?from ?to) (on-disc ?to ?disc) (smaller-disc ?disc ?from) (smaller-disc ?disc ?to) (smaller-disc ?from ?to) (smaller-disc ?to ?from) (not (clear-disc ?to))  (not (on-disc ?disc ?from))))
