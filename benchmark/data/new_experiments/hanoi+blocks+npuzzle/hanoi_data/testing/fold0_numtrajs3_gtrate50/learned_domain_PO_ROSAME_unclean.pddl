...
(:action move_disc_disc
	...
	:effect (and (clear-disc ?from) (on-disc ?disc ?to) (smaller-disc ?to ?from) (not (clear-disc ?to))  (not (on-disc ?disc ?from))  (not (on-disc ?to ?from))  (not (smaller-disc ?disc ?from))  (not (smaller-disc ?disc ?to))))
