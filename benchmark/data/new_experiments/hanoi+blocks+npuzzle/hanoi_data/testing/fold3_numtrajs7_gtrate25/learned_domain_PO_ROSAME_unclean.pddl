...
(:action move_disc_peg
	...
	:effect (and (clear-disc ?disc) (clear-disc ?from) (on-peg ?disc ?to) (smaller-disc ?disc ?from) (smaller-disc ?from ?disc) (smaller-peg ?to ?disc) (smaller-peg ?to ?from) (not (clear-peg ?to))  (not (on-disc ?disc ?from))))
