...
(:action move_disc_disc
	...
	:precondition (and (clear-disc ?disc) (on-disc ?disc ?to) (smaller-disc ?disc ?to) (smaller-disc ?from ?disc) (smaller-disc ?from ?to) (smaller-disc ?to ?disc) (smaller-disc ?to ?from))
	:effect (and (clear-disc ?from) (clear-disc ?to) (on-disc ?disc ?from) (on-disc ?from ?disc) (on-disc ?from ?to) (on-disc ?to ?disc) (on-disc ?to ?from) (not (smaller-disc ?disc ?to))))
...
(:action move_peg_disc
	...
	:precondition (and (clear-disc ?disc) (on-disc ?disc ?to) (on-disc ?to ?disc) (on-peg ?disc ?from) (smaller-disc ?to ?disc) (smaller-peg ?from ?disc) (smaller-peg ?from ?to))
	:effect (and (clear-disc ?to) (not (on-disc ?to ?disc))  (not (on-peg ?disc ?from))))
