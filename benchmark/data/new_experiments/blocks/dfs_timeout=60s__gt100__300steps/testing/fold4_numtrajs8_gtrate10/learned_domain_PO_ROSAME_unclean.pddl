...
(:action put_down
	...
	:effect (and (handempty) (holding ?x) (not (ontable ?x))  (not (clear ?x))))
...
(:action unstack
	...
	:effect (and  (not (on ?x ?y))  (not (on ?y ?x))  (not (ontable ?x))  (not (ontable ?y))  (not (clear ?x))  (not (holding ?x))  (not (holding ?y))))
