...
(define (problem maze) (:domain maze)
  ...
  (:init 
	...
	(move-dir-up loc_7_5 loc_6_5)
	(move-dir-up loc_7_7 loc_6_7)
	(oriented-down player_1)
  )
  (:goal (and (at player_1 loc_7_4)))
)
