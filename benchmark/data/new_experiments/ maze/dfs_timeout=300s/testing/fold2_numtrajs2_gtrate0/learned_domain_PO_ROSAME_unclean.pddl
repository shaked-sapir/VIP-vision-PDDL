...
(:action move_up
	...
	:precondition (and (move-dir-up ?to ?from) (move-dir-down ?to ?from) (clear ?to) (at ?p ?from) (oriented-left ?p) (is-goal ?from))
	:effect (and (move-dir-up ?from ?to) (move-dir-down ?from ?to) (move-dir-left ?from ?to) (move-dir-left ?to ?from) (move-dir-right ?from ?to) (move-dir-right ?to ?from) (clear ?from) (at ?p ?to) (oriented-up ?p) (oriented-down ?p) (oriented-right ?p) (is-goal ?to)))
