...
(:action move_disc_disc
	...
	:precondition (and (clear-disc ?to) (smaller-disc ?disc ?from) (smaller-disc ?disc ?to) (smaller-disc ?to ?from))
	:effect (and  (not (clear-disc ?to))  (not (smaller-disc ?disc ?to))  (not (smaller-disc ?to ?from))))
