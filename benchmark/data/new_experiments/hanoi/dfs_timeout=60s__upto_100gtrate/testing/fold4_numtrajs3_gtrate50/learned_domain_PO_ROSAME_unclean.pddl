...
(:action move_disc_disc
	...
	:precondition (and (clear-disc ?to) (on-disc ?disc ?from) (on-disc ?disc ?to) (on-disc ?to ?from) (smaller-disc ?disc ?from) (smaller-disc ?from ?to) (smaller-disc ?to ?disc) (smaller-disc ?to ?from))
	:effect (and  (not (clear-disc ?to))  (not (on-disc ?disc ?from))  (not (on-disc ?disc ?to))  (not (on-disc ?to ?from))  (not (smaller-disc ?disc ?from))  (not (smaller-disc ?from ?to))  (not (smaller-disc ?to ?disc))  (not (smaller-disc ?to ?from))))
