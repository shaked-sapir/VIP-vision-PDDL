...
(:action move_disc_disc
	...
	:precondition (and )
	:effect (and (clear-disc ?disc) (clear-disc ?from) (clear-disc ?to) (on-disc ?disc ?from) (on-disc ?disc ?to) (on-disc ?from ?disc) (on-disc ?from ?to) (on-disc ?to ?from) (smaller-disc ?disc ?to) (smaller-disc ?from ?disc) (smaller-disc ?from ?to) (smaller-disc ?to ?disc) (smaller-disc ?to ?from)))
