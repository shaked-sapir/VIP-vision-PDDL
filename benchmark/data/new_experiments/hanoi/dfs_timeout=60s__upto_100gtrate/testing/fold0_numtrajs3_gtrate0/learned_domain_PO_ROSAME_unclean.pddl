...
(:action move_peg_disc
	...
	:precondition (and (on-disc ?disc ?to) (smaller-disc ?disc ?to) (smaller-disc ?to ?disc) (smaller-peg ?from ?disc) (smaller-peg ?from ?to))
	:effect (and (clear-peg ?from) (clear-disc ?to) (on-disc ?to ?disc) (on-peg ?disc ?from) (on-peg ?to ?from) (not (smaller-disc ?disc ?to))))
