...
(:action move_disc_disc
	...
	:effect (and (clear-disc ?disc) (clear-disc ?from) (clear-disc ?to) (on-disc ?disc ?to) (on-disc ?from ?disc) (on-disc ?from ?to) (on-disc ?to ?disc) (on-disc ?to ?from) (smaller-disc ?disc ?from) (smaller-disc ?from ?disc) (smaller-disc ?from ?to) (smaller-disc ?to ?disc) (smaller-disc ?to ?from) (not (smaller-disc ?disc ?to))))
