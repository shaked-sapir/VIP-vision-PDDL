...
(:action move_disc_peg
	...
	:precondition (and (clear-peg ?to) (on-peg ?disc ?to) (smaller-disc ?from ?disc))
	:effect (and (clear-disc ?disc) (clear-disc ?from) (on-disc ?disc ?from) (on-disc ?from ?disc) (on-peg ?from ?to) (smaller-disc ?disc ?from) (smaller-peg ?to ?disc) (smaller-peg ?to ?from) (not (clear-peg ?to))  (not (on-peg ?disc ?to))  (not (smaller-disc ?from ?disc))))
