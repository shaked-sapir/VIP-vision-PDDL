...
(:action move_disc_peg
	...
	:precondition (and (on-disc ?disc ?from) (on-disc ?from ?disc) (on-peg ?disc ?to) (smaller-disc ?disc ?from) (smaller-disc ?from ?disc) (smaller-peg ?to ?disc) (smaller-peg ?to ?from))
	:effect (and (clear-peg ?to) (clear-disc ?disc) (clear-disc ?from) (on-peg ?from ?to)))
