...
(:action move_disc_peg
	...
	:precondition (and (clear-disc ?from) (on-disc ?disc ?from) (smaller-disc ?disc ?from) (smaller-disc ?from ?disc))
	:effect (and (clear-peg ?to) (clear-disc ?disc) (on-disc ?from ?disc) (on-peg ?disc ?to) (on-peg ?from ?to) (smaller-peg ?to ?disc) (smaller-peg ?to ?from) (not (clear-disc ?from))))
