...
(:action move_disc_disc
	...
	:effect (and (clear-disc ?to) (smaller-disc ?disc ?from) (not (clear-disc ?from))  (not (on-disc ?disc ?from))  (not (on-disc ?disc ?to))  (not (on-disc ?from ?disc))  (not (on-disc ?from ?to))  (not (on-disc ?to ?disc))  (not (on-disc ?to ?from))))
...
(:action move_peg_disc
	...
	:effect (and (clear-peg ?from) (clear-disc ?disc) (on-disc ?disc ?to) (not (on-peg ?disc ?from))))
