...
(:action move_disc_disc
	...
	:effect (and (clear-disc ?disc) (clear-disc ?from) (clear-disc ?to) (on-disc ?disc ?from) (on-disc ?disc ?to) (not (on-disc ?from ?disc))  (not (on-disc ?from ?to))  (not (on-disc ?to ?disc))  (not (on-disc ?to ?from))))
