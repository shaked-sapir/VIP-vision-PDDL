...
(:action move_disc_peg
	...
	:precondition (and (clear-peg ?to) (on-disc ?disc ?from) (smaller-peg ?to ?disc) (smaller-peg ?to ?from))
	:effect (and (clear-disc ?disc) (clear-disc ?from) (on-peg ?disc ?to) (smaller-disc ?disc ?from) (smaller-disc ?from ?disc) (not (clear-peg ?to))  (not (on-disc ?disc ?from))))
