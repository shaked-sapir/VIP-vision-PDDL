...
(:action move_disc_peg
	...
	:effect (and (clear-peg ?to) (clear-disc ?disc) (clear-disc ?from) (on-disc ?disc ?from) (on-disc ?from ?disc) (on-peg ?from ?to) (smaller-disc ?disc ?from) (smaller-disc ?from ?disc) (smaller-peg ?to ?disc) (smaller-peg ?to ?from) (not (on-peg ?disc ?to))))
