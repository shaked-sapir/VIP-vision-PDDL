...
(:action move_disc_disc
	...
	:precondition (and )
	:effect (and (clear-disc ?disc) (clear-disc ?from) (clear-disc ?to) (on-disc ?disc ?from) (on-disc ?disc ?to) (on-disc ?from ?disc) (on-disc ?from ?to) (on-disc ?to ?disc) (on-disc ?to ?from) (smaller-disc ?disc ?from) (smaller-disc ?disc ?to) (smaller-disc ?from ?to) (smaller-disc ?to ?from)))
