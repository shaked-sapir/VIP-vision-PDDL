...
(:action move_disc_disc
	...
	:precondition (and (clear-disc ?to) (on-disc ?to ?from) (smaller-disc ?to ?disc))
...
(:action move_disc_peg
	...
	:precondition (and (clear-peg ?to) (clear-disc ?disc) (on-disc ?disc ?from) (on-disc ?from ?disc) (on-peg ?disc ?to) (on-peg ?from ?to) (smaller-disc ?disc ?from) (smaller-disc ?from ?disc) (smaller-peg ?to ?disc) (smaller-peg ?to ?from))
