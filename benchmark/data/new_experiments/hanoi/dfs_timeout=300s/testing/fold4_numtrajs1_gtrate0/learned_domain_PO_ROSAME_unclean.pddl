...
(:action move_disc_disc
	...
	:precondition (and (on-disc ?from ?to) (on-disc ?to ?disc) (on-disc ?to ?from) (smaller-disc ?from ?disc) (smaller-disc ?from ?to) (smaller-disc ?to ?disc) (smaller-disc ?to ?from))
	:effect (and (clear-disc ?disc) (clear-disc ?from) (clear-disc ?to) (on-disc ?disc ?from) (on-disc ?disc ?to) (on-disc ?from ?disc) (smaller-disc ?disc ?from) (not (on-disc ?from ?to))  (not (on-disc ?to ?disc))  (not (on-disc ?to ?from))))
