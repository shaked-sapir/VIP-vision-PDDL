...
(:action move_disc_disc
	...
	:precondition (and (smaller-disc ?to ?disc))
	:effect (and (clear-disc ?disc) (clear-disc ?from) (clear-disc ?to) (on-disc ?disc ?from) (on-disc ?disc ?to) (on-disc ?from ?disc) (on-disc ?to ?disc) (on-disc ?to ?from) (smaller-disc ?disc ?from) (smaller-disc ?disc ?to) (smaller-disc ?from ?disc) (smaller-disc ?from ?to) (smaller-disc ?to ?from)))
...
(:action move_peg_disc
	...
	:effect (and (on-disc ?disc ?to) (on-disc ?to ?disc) (on-peg ?to ?from) (smaller-disc ?disc ?to) (not (on-peg ?disc ?from))))
